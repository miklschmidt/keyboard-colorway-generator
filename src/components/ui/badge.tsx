...
export const badgeTextColorStyle = cva('', {
	variants: {
		color: {
			...
			quaternary: 'text-quaternary-700 dark:text-quaternary-400',
...
export const badgeBackgroundColorStyle = cva('', {
	variants: {
		color: {
			...
			primary: 'bg-primary-50 dark:bg-primary-400/10',
			secondary: 'bg-secondary-50 dark:bg-secondary-400/10',
			tertiary: 'bg-tertiary-50 dark:bg-tertiary-400/10',
			quaternary: 'bg-quaternary-50 dark:bg-quaternary-400/10',
...
export const badgeBorderColorStyle = cva('', {
	variants: {
		color: {
			...
			primary: 'border-primary-600/40 dark:border-primary-400/30 ring-primary-600/40 dark:ring-primary-400/30',
			secondary:
				'border-secondary-600/40 dark:border-secondary-400/30 ring-secondary-600/40 dark:ring-secondary-400/30',
			tertiary: 'border-tertiary-600/40 dark:border-tertiary-400/30 ring-tertiary-600/40 dark:ring-tertiary-400/30',
			quaternary:
				'border-quaternary-600/40 dark:border-quaternary-400/30 ring-quaternary-600/40 dark:ring-quaternary-400/30',
...
const badgeStyle = cva('flex-0 inline-flex w-auto items-center rounded-md font-medium ring-1 ring-inset', {
	variants: {
		...
		color: {
			...
			primary: [
				badgeBackgroundColorStyle({ color: 'primary' }),
				badgeBorderColorStyle({ color: 'primary' }),
				badgeTextColorStyle({ color: 'primary' }),
			],
			secondary: [
				badgeBackgroundColorStyle({ color: 'secondary' }),
				badgeBorderColorStyle({ color: 'secondary' }),
				badgeTextColorStyle({ color: 'secondary' }),
			],
			tertiary: [
				badgeBackgroundColorStyle({ color: 'tertiary' }),
				badgeBorderColorStyle({ color: 'tertiary' }),
				badgeTextColorStyle({ color: 'tertiary' }),
			],
			quaternary: [
				badgeBackgroundColorStyle({ color: 'quaternary' }),
				badgeBorderColorStyle({ color: 'quaternary' }),
				badgeTextColorStyle({ color: 'quaternary' }),
			],
			gray: [
...
export const Badge: React.FC<BadgeProps> = (props) => {
	...
	return (
		<span className={cn(badgeStyle({ size, color }), className)} {...forwardProps}>
			{children}
		</span>
	);
};
